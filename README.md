...
```
apt-get update -y && apt-get install git -y && git clone https://github.com/niyom007/AUTORUN-CCMINER-SERVER && cd AUTORUN-CCMINER-SERVER && chmod +x setup.sh && sh setup.sh
```
